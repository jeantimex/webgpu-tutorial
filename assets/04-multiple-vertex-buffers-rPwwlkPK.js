import"./common-BNB2xREb.js";import{i as B}from"./webgpu-util-BApOR-AX.js";async function g(){const o=document.querySelector("#webgpu-canvas"),{device:e,context:u,canvasFormat:f}=await B(o),r=new Float32Array([0,.5,-.5,-.5,.5,-.5]),a=new Float32Array([1,0,0,0,1,0,0,0,1]),n=e.createBuffer({label:"Position Buffer",size:r.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(n,0,r);const i=e.createBuffer({label:"Color Buffer",size:a.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(i,0,a);const s=e.createShaderModule({label:"Multiple Buffers Shader",code:`
      struct VertexOutput {
