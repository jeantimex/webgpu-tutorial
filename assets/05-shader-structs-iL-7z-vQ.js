import{i as d}from"./webgpu-util-GTOb4j6a.js";async function m(){const r=document.querySelector("#webgpu-canvas"),{device:e,context:u,canvasFormat:c}=await d(r),o=new Float32Array([0,.5,1,0,0,-.5,-.5,0,1,0,.5,-.5,0,0,1]),n=e.createBuffer({label:"Interleaved Vertex Buffer",size:o.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(n,0,o);const a=e.createShaderModule({label:"Shader Structs",code:`
