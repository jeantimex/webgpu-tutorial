import"../../../modulepreload-polyfill-B5Qt9EMX.js";import{r as p}from"../../../canvas-util-Dbsun61p.js";import{i as v}from"../../../webgpu-util-BApOR-AX.js";async function m(){const t=document.querySelector("#webgpu-canvas"),{device:e,context:s,canvasFormat:u}=await v(t),o=new Float32Array([0,.5,1,0,0,-.5,-.5,0,1,0,.5,-.5,0,0,1]),a=e.createBuffer({label:"Interleaved Vertex Buffer",size:o.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(a,0,o);const n=e.createShaderModule({label:"Interleaved Buffer Shader",code:`
      struct VertexOutput {
