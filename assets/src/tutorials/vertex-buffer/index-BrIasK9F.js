import"../../../modulepreload-polyfill-B5Qt9EMX.js";import{r as m}from"../../../canvas-util-Dbsun61p.js";import{i as v}from"../../../webgpu-util-BApOR-AX.js";async function p(){const t=document.querySelector("#webgpu-canvas"),{device:e,context:c,canvasFormat:f}=await v(t),n=new Float32Array([0,.5,-.5,-.5,.5,-.5]),o=e.createBuffer({label:"Triangle Vertex Buffer",size:n.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(o,0,n);const a=e.createShaderModule({label:"Vertex Buffer Shader",code:`
      @vertex
