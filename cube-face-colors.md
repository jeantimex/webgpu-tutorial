...
In [Tutorial 26](indexed-cube.html), we used an **Index Buffer** to optimize a cube by sharing vertices. We reused the 8 corner vertices to draw all 12 triangles.
