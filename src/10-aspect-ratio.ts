...
async function init() {
  ...
  function updateTransformation() {
    ...
    // This acts as a simple "Projection Matrix".
    // We scale the X-axis by (1 / aspect) to compensate for the wide canvas.
    // This must be applied first (which means last in the chain P * M * v)
    // to affect the final clip-space coordinates.
