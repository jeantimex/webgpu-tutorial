...
In the previous [Hello Cube](hello-cube.html) tutorial, we drew a cube using `draw(36)`. Since a cube has 6 faces and each face is made of 2 triangles (6 vertices), we needed 6 * 6 = 36 vertices.
